...
/// </summary>
public class SteelMaterial : MaterialProperty
{
    public override eMatType MaterialType => eMatType.Steel;
    ...
    /// </summary>
    public double StrainAtMaxStress { get; set; } = 0.1;

    /// <summary>
    /// Strain at rupture
    /// </summary>
    public double StrainAtRupture { get; set; } = 0.2;
    ...
    /// <summary>
    /// Temperature for steel properties
    /// </summary>
    ...
    /// <summary>
    /// Creates steel material with typical values
    /// </summary>
    public static SteelMaterial Create(string name, double fy, double fu)
    {
        return new SteelMaterial
        {
            ...
            {
                E = 29000, // ksi for US, adjust for other units
                U = 0.3,
                A = 6.5e-6
            }
        };
